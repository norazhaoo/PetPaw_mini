...
module.exports = {
  ...
  help: '帮助与支持', contact_service: '联系客服', about: '关于 PetPaw',
  ...
  calendar_view: '日历', journal_title: '宠物日记',
  journal_today_title: '今天的宠物日记',
  journal_entry_hint: '记录一段生活、心情或照片',
  journal_notebook_hint: '按时间倒序查看生活片段',
  ...
  journal_empty: '还没有宠物日记',
  journal_continue: '继续写一篇',
  journal_save_empty: '写点文字、选个心情或加张照片吧',
  journal_filter_all: '全部',
  journal_mood_good: '乖乖',
  journal_mood_clingy: '粘人',
  journal_mood_mischief: '捣蛋',
  journal_mood_sleepy: '嗜睡',
  journal_mood_good_appetite: '胃口好',
  journal_mood_unusual: '有点异常',
